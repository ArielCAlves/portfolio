    ...
    >
      <div>       
        <div style={{ textAlign: 'justify', wordSpacing: '-1px' }} className="mt-14 w-full h-[1300px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            subTitle="AppIA"
            result="Atual"
            des="Atua, principalmente, com pesquisa e construção de modelos que visam solucionar problemas relacionados à Previsão de Demanda (Séries Temporais) utilizando estatística avançada e econometria, além do máximo de poder computacional de cada máquina disponível de acordo com a situação."
          />
          <ResumeCard
          ...
          />
          <ResumeCard
            title="Desenvolvedor Backend | Analista de Dados"
            subTitle="Lym Tech"
            result="2021"
      ...
      <div>
        <div style={{ textAlign: 'justify', wordSpacing: '-1px' }} className="mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            title="Cientista de Dados | Consultor"
            subTitle="Freelancer"
            result="2022-Atual"
