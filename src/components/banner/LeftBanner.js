...
const LeftBanner = () => {
    const [text] = useTypewriter({
      words: ["Engenheiro de Software.", "Estatístico.", "Cientista de Dados.","Engenheiro de IA.","Consultor.", "Solucionador de Problemas de Negócios.", "Escritor nas horas vagas", "Aspirante à Palestrante."],
      loop: true,
      typeSpeed: 20,
      deleteSpeed: 10,
      delaySpeed: 2000,
